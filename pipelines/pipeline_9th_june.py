...
# Pipelines
from nomeroff_net.tools.composite_pipeline import CompositePipeline
from nomeroff_net.tools.pipeline import Pipeline
from nomeroff_net.tools.pipeline import empty_method
from nomeroff_net.tools.pipeline import BaseImageLoader
from nomeroff_net.tools.pipeline import unzip
from nomeroff_net.tools.image_processing import crop_number_plate_zones_from_images, group_by_image_ids


# Car Detection
from nomeroff_net.car_on_image_base.is_car_on_image import CarDetection

# Number plate localization
from nomeroff_net.localization_base.localization_main_class import NumberPlateLocalization as DefaultNumberPlateLocalization

# Number plate key points detection
from nomeroff_net.key_points_detection_base.key_points_main_class import NumberPlateKeyPointsDetection

# number plate classification 
from nomeroff_net.classification_base.classification_main_class import NumberPlateClassification

# Quadratic reader
from nomeroff_net.multiline_ocr_base.multiline_ocr import QuadraticMultilineReader

# Simple reader
from nomeroff_net.text_detector_base.number_plate_text_reading import NumberPlateTextReading
...
if __name__ == '__main__':
    ...
    frames = [cv2.imread('/Users/maratorozaliev/Desktop/trash_of_marat_51.jpg')]
    import time
    total_result = 0.0
    for frame in frames:
