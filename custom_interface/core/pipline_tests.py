...
from custom_interface.core.custom_piplineV3 import get_text_and_region_one, CustomPipline
from custom_interface.core.custom_pipline2 import get_text_and_region_one as get_text_and_region_one_1, CustomPipline as CustomPipline1
